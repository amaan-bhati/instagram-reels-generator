...
export const X6Record: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      <Camera duration={PV9.record} zoom={0.02} origin="50% 44%">
        <Stage gap={24}>
          ...
          <div style={{...enter(frame, fps, 92), marginTop: 8}}>
            <Chip
      ...
      <Caption opacity={enter(frame, fps, 106).opacity}>
