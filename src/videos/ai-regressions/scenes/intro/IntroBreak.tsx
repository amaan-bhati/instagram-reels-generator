...
export const IntroBreak: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      */}
      <Camera duration={150} zoom={0.018} origin={`50% ${((TOP + 6) / canvas.height) * 100}%`}>
        <AbsoluteFill>
          <div
            style={{
              position: 'absolute',
          ...
          >
            ...
            */}
            ...
            <div style={{marginTop: 24, height: H_BANNER}}>
              <FailureBanner label="N number of features broke in production" at={106} width={LIST_W} />
            </div>
          </div>
        </AbsoluteFill>
      </Camera>
