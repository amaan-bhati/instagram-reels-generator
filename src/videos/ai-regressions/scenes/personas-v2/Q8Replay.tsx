...
export const Q8Replay: React.FC = () => {
  const frame = useCurrentFrame();
  const {fps} = useVideoConfig();
  return (
    <AbsoluteFill>
      <Camera duration={PV.replay} zoom={0.024} origin="50% 46%">
        <Stage gap={24}>
