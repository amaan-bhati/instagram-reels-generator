...
const CASES: {method: 'GET' | 'POST' | 'PUT' | 'DELETE' | 'PATCH'; at: number; bars: number[]}[] = [
  {method: 'POST', at: 22, bars: [168, 104]},
  {method: 'GET', at: 28, bars: [140, 86]},
  {method: 'PUT', at: 34, bars: [152, 118]},
  {method: 'DELETE', at: 40, bars: [124, 96]},
  {method: 'GET', at: 46, bars: [176, 80]},
  {method: 'PATCH', at: 52, bars: [136, 110]},
];

export const SH4Generate: React.FC = () => {
  const frame = useCurrentFrame();
  const {fps} = useVideoConfig();
  const b = breathe(frame, fps, 1.5);
  return (
    <AbsoluteFill>
      <Camera duration={S.generate} zoom={0.026} origin="50% 46%">
        <Stage gap={22}>
          ...
          <div style={{...enter(frame, fps, 96), marginTop: 8}}>
